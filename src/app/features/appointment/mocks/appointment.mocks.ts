...
export const APPOINTMENTS_MOCK: AppointmentResponse[] = [
...

  {
    ...
    doctorId: 2,
    appointmentTypeId: 2,
    scheduledAt: '2026-09-17T11:00:00',
    durationMinutes: 60,
...

  {
    ...
    doctorId: 2,
    appointmentTypeId: 1,
    scheduledAt: '2026-09-18T12:30:00',
    durationMinutes: 45,
...
// Fecha local (YYYY-MM-DD); toISOString usaría UTC y por la noche daría el día siguiente
...
// Mismas citas movidas a la fecha actual para que siempre haya datos en "Hoy"
export const APPOINTMENTS_TODAY_MOCK: AppointmentResponse[] =
  APPOINTMENTS_MOCK.map((appointment) => ({
    ...appointment,
    scheduledAt: appointment.scheduledAt.replace(
      /^\d{4}-\d{2}-\d{2}/,
      getTodayDate(),
    ),
  }));
